...
if menu == "Dashboard":
    ...
    c.execute("SELECT count(*) FROM video_snapshots")
    snapshots_count = c.fetchone()[0]
    ...
    # Configure the dataframe to render images and links
    st.dataframe(
        df,
        column_config={
            ...
            "video_url": st.column_config.LinkColumn(
                "Video Link",
                display_text=r"https://youtube\.com/watch\?v=(.*)"
            ),
